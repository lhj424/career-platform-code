...
public class RecommendConfig {
    ...
    public static class Scoring {
        /** 技能匹配权重（V2：多源融合+ID精准匹配+岗位加权） */
        private double weightSkill = 0.55;
        /** 测评适配权重 */
        private double weightAssessment = 0.10;
        /** 学习完成权重（V2：已废弃，保留向后兼容） */
        private double weightLearning = 0.00;
        /** 学习成果测评权重（V2：已废弃，保留向后兼容） */
        private double weightLearningResult = 0.00;
        /** 学习掌握权重（V2：合并学习进度+学习成果） */
        private double weightMastery = 0.20;
        /** 基础匹配权重 */
        private double weightBasic = 0.15;
    }
