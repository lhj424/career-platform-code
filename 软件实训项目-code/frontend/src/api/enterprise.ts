...
// V2：岗位人才匹配
export const matchByJob = (jobId: number, filters?: {
  education?: string
  city?: string
  skillPreference?: string
}) => request.post(`/enterprise/jobs/${jobId}/match`, filters || {})

// 技能库
export const getAllSkills = () => request.get('/enterprise/skills')
export const getJobSkills = (jobId: number) => request.get(`/enterprise/jobs/${jobId}/skills`)
